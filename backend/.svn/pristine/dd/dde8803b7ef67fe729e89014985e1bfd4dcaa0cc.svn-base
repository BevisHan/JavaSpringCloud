<template>
    ...
    <el-dialog title="新增岗位" :visible.sync="dialogAdd" :close-on-click-modal="false" class="postDialog">
      <el-dialog 
        width="30%"
        title="选择部门"
    ...
    <el-dialog title="修改岗位" :visible.sync="dialogEdit" :close-on-click-modal="false" class="postDialog" :before-close="cancelDialog">
...
<style>
.postDialog .el-form-item__error {
  padding-top: 0;
}
