...
export default {
  data() {
    return {
      ...
      isShortLength:false,
      openeds:[],
      imgSrc:require('../../../static/img/close.png'),//收缩展示图片切换 默认
      items: [],
        ...
        var listDemo=[
          { 
            ...
            children:[
              { 
                disabled: false,
                id: "2018033010100277111",
                index: "user",
                label: "用户管理",
                pid: "2018033010100227777",
                type: "menu",
              },
              { 
                disabled: false,
                id: "2018033010100277112",
                index: "menu",
                label: "菜单管理",
                pid: "2018033010100227777",
                type: "menu",
          ...
          { 
            ...
            children:[
              { 
                disabled: false,
                id: "2018033010100278111",
                index: "classification",
                label: "分类管理",
                pid: "2018033010100228888",
                type: "aaa",
              },
              { 
                disabled: false,
                id: "2018033010100278112",
                index: "goods",
                label: "商品管理",
                pid: "2018033010100228888",
                type: "menu",
