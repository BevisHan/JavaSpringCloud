    ...
    <div class="user-info">
      <el-dropdown trigger="click" @command="handleCommand">
        <span class="el-dropdown-link">
          <img class="user-logo" :src="Customer">
          {{username}}
        </span>
...
export default {
  data() {
    ...
    return {
      Customer:require("../../../static/img/img.jpg"),
      name: "zzh",
      activeName: "",
      firstLeave: [],
      changePswList: {
  ...
  methods: {
    ...
    getFirstLeaveData() {
      ...
      // this.firstLeave =listDemo
        let list = {
                name:'2018033010092412205'
            };
            this.activeName='2018033010092412205';//默认选中一级菜单第一个
